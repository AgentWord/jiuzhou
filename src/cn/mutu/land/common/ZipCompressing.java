...
public class ZipCompressing {
	...
	public static void main(String[] args) {
		// try {
		// ZipCompressing.zip("d:/test_o/抗日战争史报告.zip",new
		// File("d:/抗日战争史报告.docx")); //测试单个文件
		// ZipCompressing.zip("d:/test_o/班费情况2016.zip", new
		// File("d:/班费情况2016.6.8.xls"), new File("d:/抗日战争史报告.docx")); //测试多个文件
		// ZipCompressing.zip("d:/test_o/14727844400611.zip", new
		// File("d:/test_uploadfile2/2012/14727844400611")); //测试压缩目录
		// } catch (Exception e) {
		// e.printStackTrace();
		// }
