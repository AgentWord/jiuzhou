...
Ext.define('MyApp.view.intensityuse_IndexIdealValueBinding', {
                    ...
                    items: [
                        {
                            ...
                            items: [
                                ...
                                {
                                    xtype: 'hiddenfield',
                                    id: 'intensity_ideal_projectIdIndustryFormText',
                                    fieldLabel: 'Label',
                                    name: 'projectId'
                                },
                                {
                    ...
                    items: [
                        {
                                    ...
                                    items: [
                                        {
                                            ...
                                            handler: function() {
                                                var combo = Ext.getCmp('intensity_ideal_kfqTypeText');
                                                var comboValue = combo.getValue();
                                                console.log("开发区名称："+comboValue);
                                                var comboRawValue = combo.getRawValue();
                                                if(!comboValue){
                                                    Ext.Msg.alert('提示','请先在下方的“指标现状历史数据”中选择待评价地区的指标值汇总数据，再进行指标理想值打分。');
                                                    return;
                                                }
                            ...
                            items: [
                                ...
                                {
                                    xtype: 'hiddenfield',
                                    id: 'intensity_ideal_projectIdCityFormText',
                                    fieldLabel: 'Label',
                                    name: 'projectId'
                                },
                                {
            ...
            dockedItems: [
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            xtype: 'button',
                            handler: function() {
                                var projectId=Ext.getCmp('intensity_ideal_kfqProjectIdText').getValue();
                                var formId;
                                var activeTabId = Ext.getCmp('intensity_ideal_tabPanel').getActiveTab().getId();
                                if(activeTabId.indexOf('industry') >=0){
                                    formId = 'intensity_ideal_industryForm';
                                    Ext.getCmp('intensity_idealIndustry_MarkTypeField').setValue('理想值汇总');
                                    Ext.getCmp('intensity_ideal_projectIdIndustryFormText').setValue(projectId);

                                }else{
                                    formId = 'intensity_ideal_cityForm';
                                    Ext.getCmp('intensity_idealCity_MarkTypeField').setValue('理想值汇总');
                                    Ext.getCmp('intensity_ideal_projectIdCityFormText').setValue(projectId);
                                    //Ext.getCmp('intensity_ideal_kfqTypeIndustryFormText').setValue(comboValue);
                                }
    ...
    dockedItems: [
        {
            ...
            items: [
                ...
                {
                    xtype: 'textfield',
                    id: 'intensity_ideal_kfqProjectIdText',
                    width: 250,
                    fieldLabel: '开发区评价类型',
                    submitValue: false,
                    readOnly: true
    ...
    onIntensity_ideal_kfqAreaComboChange: function(field, newValue, oldValue, eOpts) {
        ...
        var record = store.findRecord('kfqName',field.getRawValue());
        console.log(record);
        ...
        Ext.getCmp('intensity_ideal_kfqNameIndustryFormText').setValue(kfqName);
        Ext.getCmp('intensity_ideal_kfqNameCityFormText').setValue(kfqName);
        Ext.getCmp('intensity_ideal_kfqTypeIndustryFormText').setValue(kfqType);
        Ext.getCmp('intensity_ideal_kfqTypeCityFormText').setValue(kfqType);
        ...
        //top toolbar text
        Ext.getCmp('intensity_ideal_kfqProjectIdText').setValue(projectId);
