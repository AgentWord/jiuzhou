...
Ext.define('MyApp.view.intensityPotential_Construct', {
            ...
            items: [
                ...
                },
                {
                    ...
                    handler: function() {
                        ...
                        var mainWeight = Ext.getCmp('construct_mainIndexValueField').getValue();
                        var mainIdeal = Ext.getCmp('construct_mainIdealField').getValue();
                        var mainYjccz = Ext.getCmp('construct_mainYjcczField').getValue();
                        var developWeight = Ext.getCmp('construct_developIndexValueField').getValue();
                        ...
                        var mainConstruct = mainYjccz*(mainIdeal-mainWeight)/100;
                        var developConstruct = developYjccz*(developIdeal-developWeight)/100;

                        Ext.getCmp('construct_mainConstructField').setValue(mainConstruct.toFixed(2));
                        Ext.getCmp('construct_developConstructField').setValue(developConstruct.toFixed(2));
                    },
                    text: '结构潜力测算'
                },
                {
    ...
    items: [
        {
            ...
            items: [
                ...
                },
                {
                    xtype: 'textfield',
                    colspan: 2,
                    id: 'construct_mainIndexValueField',
                    width: 160,
                    fieldLabel: '工业用地率',
                    labelWidth: 80,
                ...
                },
                {
                    xtype: 'textfield',
                    colspan: 1,
                    id: 'construct_developIndexValueField',
                    width: 80,
    ...
    onPanelAfterRender: function(component, eOpts) {
        var count =Ext.StoreMgr.get('landIndexIdealStore').getCount();
        console.log(count);
    }
