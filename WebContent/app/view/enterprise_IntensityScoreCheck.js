/*
 * File: app/view/enterprise_IntensityScoreCheck.js
 *
...
Ext.define('MyApp.view.enterprise_IntensityScoreCheck', {
    extend: 'Ext.window.Window',
    alias: 'widget.enterprise_IntensityScoreCheck',
    ...
    dockedItems: [
        {
            ...
            items: [
                ...
                {
                    xtype: 'textfield',
                    id: 'intensity_value_kfqAreaText1',
                    width: 200,
                    fieldLabel: '开发区名称',
                    labelWidth: 70,
                    submitValue: false
                },
                {
                    xtype: 'textfield',
                    hidden: true,
                    id: 'intensity_value_activeFormId1',
                    width: 200,
                    fieldLabel: '开发区名称',
                    labelWidth: 70,
                    submitValue: false
                ...
                },
                {
                    ...
                    handler: function() {
                        ...
                        script.src="mapjs/intensity_value_caculate.js";//DLDM_GYDM_ValueCalculation_map.js";
    ...
    items: [
        {
            xtype: 'tabpanel',
            id: 'intensity_value_tabPanel1',
            activeTab: 0,
            items: [
                {
                    xtype: 'panel',
                    tabIndex: 0,
                    id: 'indensity_value_industryTab1',
                    layout: 'fit',
                    title: '工业主导型',
                    items: [
                        {
                            xtype: 'form',
                            height: 500,
                            id: 'intensity_value_industryForm1',
                            layout: 'fit',
                            bodyPadding: 10,
                            jsonSubmit: true,
                            items: [
                                ...
                                {
                                    xtype: 'hiddenfield',
                                    id: 'intensity_value_kfqNameIndustryFormText1',
                                    fieldLabel: 'Label',
                                    name: 'kfqName',
                                    value: 0
                                },
                                {
                                    xtype: 'hiddenfield',
                                    id: 'intensity_value_kfqTypeIndustryFormText1',
                                    fieldLabel: 'Label',
                                    name: 'kfqType',
                                    value: 0
                                },
                    ...
                    items: [
                        {
                            ...
                            items: [
                                ...
                                {
                                    xtype: 'hiddenfield',
                                    id: 'intensity_value_kfqNameCityFormText1',
                                    fieldLabel: 'Label',
                                    name: 'kfqName',
                                    value: 0
                                },
                                {
                                    xtype: 'hiddenfield',
                                    id: 'intensity_value_kfqTypeCityFormText1',
                                    fieldLabel: 'Label',
                                    name: 'kfqType',
                                    value: 0
                                }
