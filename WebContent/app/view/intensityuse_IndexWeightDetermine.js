...
Ext.define('MyApp.view.intensityuse_IndexWeightDetermine', {
            ...
            dockedItems: [
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            xtype: 'button',
                            handler: function() {
                                var projectId=Ext.getCmp('intensity_weight_kfqProjectIdText').getValue();
                                var combo = Ext.getCmp('intensity_weight_kfqAreaCombo');
                                var comboValue = combo.getValue();
                                ...
                                if(activeTabId.indexOf('industry') >=0){
                                    formId = 'intensity_weight_industryForm';
                                    Ext.getCmp('intensity_weight_projectIdIndustryFormText').setValue(projectId);
                                    ...
                                    formId = 'intensity_weight_cityForm';
                                    Ext.getCmp('intensity_weight_projectIdCityFormText').setValue(projectId);
    ...
    dockedItems: [
            ...
            items: [
                {
                    ...
                    valueField: 'kfqType',
                    listeners: {
                        change: 'onIntensity_ideal_kfqAreaComboChange1'
                    }
                },
                {
                    xtype: 'textfield',
                ...
                {
                    xtype: 'textfield',
                    id: 'intensity_weight_kfqProjectIdText',
                    width: 250,
                    fieldLabel: '评价编号',
                    submitValue: false
                }
        ...
        },
        {
            ...
            items: [
                {
                    xtype: 'combobox',
                    id: 'intensity_weight_kfqAreaCombo1',
                    width: 220,
                    fieldLabel: '已评价开发区',
                    name: '',
                    submitValue: false,
    ...
    onIntensity_ideal_kfqAreaComboChange1: function(field, newValue, oldValue, eOpts) {
        ...
        //top toolbar text
        Ext.getCmp('intensity_weight_kfqProjectIdText').setValue(projectId);
        //Ext.getCmp('intensity_weight_kfqTypeText').setValue(kfqType);
